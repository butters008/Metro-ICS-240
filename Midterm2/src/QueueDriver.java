...
public class QueueDriver {
	...
	public static boolean compareTo (IntQueueInterface q1, IntQueueInterface q2) {
		if(q1.equals(q2)) {
			return true;
		}else {
			return false;			
	...
	public static void main(String[] args) {
			...
			IntQueueInterface q2 = new IntArrayQueue(20);
			...
			q2.add(30);
			q2.add(40);
			q2.add(50);//testing for true
//			q2.add(60);//testing for false
			
			System.out.println(compareTo(q1, q2));
